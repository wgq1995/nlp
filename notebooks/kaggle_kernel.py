...
outputs = []
pred_val_y, pred_test_y = train_pred(model_gru_atten_3(embedding_matrix), epochs = 4)
outputs.append([pred_val_y, pred_test_y, '3 GRU w/ atten'])

pred_val_y, pred_test_y = train_pred(model_gru_srk_atten(embedding_matrix), epochs = 4)
outputs.append([pred_val_y, pred_test_y, 'gru atten srk'])

pred_val_y, pred_test_y = train_pred(model_cnn(embedding_matrix_1), epochs = 4) # GloVe only
outputs.append([pred_val_y, pred_test_y, '2d CNN GloVe'])

pred_val_y, pred_test_y = train_pred(model_lstm_du(embedding_matrix), epochs = 4)
outputs.append([pred_val_y, pred_test_y, 'LSTM DU'])

pred_val_y, pred_test_y = train_pred(model_lstm_atten(embedding_matrix), epochs = 5)
outputs.append([pred_val_y, pred_test_y, '2 LSTM w/ attention'])

pred_val_y, pred_test_y = train_pred(model_lstm_atten(embedding_matrix_1), epochs = 5) # Only GloVe
outputs.append([pred_val_y, pred_test_y, '2 LSTM w/ attention GloVe'])

pred_val_y, pred_test_y = train_pred(model_lstm_atten(embedding_matrix_3), epochs = 5) # Only Para
